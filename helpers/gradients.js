...
const goodGradientsNames = ['sunrise', 'stripe', 'bloody mary', 'electric violet', 'mojito', 'juicy orange', 'cherry', 'soundcloud', 'facebook messenger', 'amethyst', 'dance to forget', 'dirty fog', 'reef', 'nelson', 'aqualicious', 'kyoto', 'a lost memory', 'blurry beach', 'day tripper', 'shrimpy', 'stellar']

const goodGradients = filter(gradients, ({ name }) => includes(goodGradientsNames, toLower(name)))

export default goodGradients
